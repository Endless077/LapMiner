...
def report_laps(file, laps, tracks, vehicles, json_tracks, json_vehicles):
    ...
    file.write("######################\n\n")
    file.write("--Track vehicle category count:\n\n")
