...
class LapTime:
    ...
    def __init__(self, lap_id: int, lap_time: float, driver: str, track: dict, vehicle: dict) -> None:
        # local variables
...
class Vehicle:
    ...
    # Init function
    def __init__(self, vehicle_id: int, vehicle_name: str, class_type: str, ) -> None:
        # local variables
...
class Car(Vehicle):
    ...
    def __init__(self, vehicle_id: int, vehicle_name: str, class_type: str,
                ...
                trasmission: dict, performance: dict, overview: dict) -> None:
...
class Layout:
    ...
    # Init function
    def __init__(self, layout_id: int, enigne_layout: str, wheel_drive: str, class_type: str) -> None:
        self.__layout_id = layout_id
        self.__engine_layout = enigne_layout
    ...
    @property
    def enigne_layout(self):
        return self.__enigne_layout
    @enigne_layout.setter
    def enigne_layout(self, value):
        self.__enigne_layout = value
